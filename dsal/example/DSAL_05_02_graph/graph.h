...
void initGraph_List(GraphList *g, const char *fileName); /* 데이터파일에서 그래프의 정점과 간선 정보를 입력 받아 그래프를 인접 리스트법으로 초기화하는 함수 */
void outputGraph_List(GraphList *g); /* 그래프내의 정점과 간선의 관계를 인접 리스트 형태로 출력 */
bool addNode(GraphList *g, int vNum1, int vNum2); /* 두 정점의 관계를 리스트에 등록함 */
