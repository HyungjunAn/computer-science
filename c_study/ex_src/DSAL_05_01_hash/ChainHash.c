...
void mInput(Hash *sp); /* 입력메뉴 처리 함수 */
void myDelete(Hash *sp); /* 삭제메뉴 처리 함수 */
void mSearch(Hash *sp); /* 검색메뉴 처리 함수 */
...
int main() {
	...
	while (1) {
		...
		case 2:
			...
			break;
		case 3:
			mSearch(&lhash); /* hash내의 모든 데이터 출력하기*/
		}
	}
